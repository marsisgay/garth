Router.map(function() {
    ...
    this.route('playersdata', {
        name: 'playersdata',
        path: '/playersdata',
        layoutTemplate: 'playersdata'
    });

    this.route('donationsdata', {
        name: 'donationsdata',
        path: '/donationsdata',
        layoutTemplate: 'donationsdata'
    });

this.route('behaviouraldata', {
        name: 'behaviouraldata',
        path: '/behaviouraldata',
        layoutTemplate: 'behaviouraldata'
    });
