...
Session.setDefault('minimumScore',10);
...
Template.donate.helpers({
    ...
    lastRoundWealth: function(){
        ...
        if(tempE>4){
            ...
            console.log("notenough to continue");
            return false;}
        }    
...
Template.receive.events({
    'click #checkfordonations': function(){
     ...
     thisID = Session.get('myID');
     myPlayerID = Behaviour.findOne({playerID:thisID})._id;
